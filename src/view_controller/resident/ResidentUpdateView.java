...
public class ResidentUpdateView extends BaseView {
    ...
    private void onSearchByCCCD(ActionEvent actionEvent) {
        ...
        if (resident != null) {
            ...
            LocalDate _birthDate = LocalDate.of(birthDate.getYear() + 1900, birthDate.getMonth() + 1,
                    birthDate.getDate());
            ...
            LocalDate _issueDate = LocalDate.of(issueDate.getYear() + 1900, issueDate.getMonth() + 1,
                    issueDate.getDate());
