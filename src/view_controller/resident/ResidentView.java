...
public class ResidentView extends BaseView {
    ...
    @FXML private TableColumn<Resident, String> colHoTen;
    @FXML private TableColumn<Resident, String> colNgaySinh;
    @FXML private TableColumn<Resident, String> colGioiTinh;
    @FXML private TableColumn<Resident, String> colDanToc;
    @FXML private TableColumn<Resident, String> colTonGiao;
    @FXML private TableColumn<Resident, String> colCMND;
    @FXML private TableColumn<Resident, String> colNgheNghiep;
    @FXML private TableColumn<Resident, String> colNgayCap;
    @FXML private TableColumn<Resident, String> colNoiCap;
    @FXML private TableColumn<Resident, Integer> colID;
    @FXML private TableColumn<Resident, Integer> colHoKhauID;
    ...
    @FXML private void onAddResident(ActionEvent actionEvent) {
        ViewController.getInstance().openView(new ResidentAddView(), "Thêm cư dân", 1000, 700);
    }

    @FXML private void onUpdateResident(ActionEvent actionEvent) {
        ViewController.getInstance().openView(new ResidentUpdateView(), "Cập nhật cư dân", 1000, 700);
    }

    @FXML private void onDeleteResident(ActionEvent actionEvent) {
