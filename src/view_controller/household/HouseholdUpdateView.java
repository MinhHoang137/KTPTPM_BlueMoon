...
public class HouseholdUpdateView extends BaseView {
    ...
    @FXML private void onSave() throws SQLException {
        ...
        boolean res = HouseholdController.getInstance().updateHouseholdByNumber(householdNumber, ownerId, registrationDate);
        if (res) {
    ...
    @FXML private void onSearchByNumber(){
        String householdNumber = tfHouseholdNumber.getText();
