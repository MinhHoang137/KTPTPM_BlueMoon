...
public class HouseholdView extends BaseView {
    ...
    @FXML
    private Button btnSearchById, btnSearchByNumber, btnAdd, btnUpdate, btnDelete;
    @FXML
    ...
    @FXML
    private TableColumn<Household, String> colOwnerId;
    @FXML
    private TableColumn<Household, java.util.Date> colRegistrationDate;
